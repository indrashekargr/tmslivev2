 ...
 * @license MIT
 */
//var LoginPageUrl = "http://imssems.azurewebsites.net/#/";
//var LoginPageUrl = "http://emsuat.azurewebsites.net/#/";
var LoginPageUrl = "http://172.16.1.75/EMSv1.9/#/";
//LoginPageUrl is the url of login page after hosting application in a server
(function (window, angular, undefined) {
    ...
    angular.module('ngIdle.title', []).provider('Title', function () {
        ...
        this.$get = ['$document', '$interpolate', '$window', '$location', function ($document, $interpolate, $window, $location) {
            var state = {
                original: null
                , idle: '{{minutes}}:{{seconds}} until your session times out!'
                , timedout: LoginPageUrl
            };
            return {
